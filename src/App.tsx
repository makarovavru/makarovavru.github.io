  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <div>
          <h2>О себе</h2>
          <p>Меня зовут Александр, если в кратце в ИТ более 13 лет, работал в разных направлениях таких как back,
            devops, сейчас на фронте, работал в крупных компаниях :)</p>
        </div>
      </header>
    </div>
  );
